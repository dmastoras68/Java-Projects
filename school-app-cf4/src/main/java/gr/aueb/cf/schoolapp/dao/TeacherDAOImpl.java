...
public class TeacherDAOImpl implements ITeacherDAO{
    ...
    public Teacher insert(Teacher teacher) throws TeacherDAOException {
        ...
        try(Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            throw new TeacherDAOException("SQL Error in Teacher.insert " + teacher.toString());
        }
        return teacher;
    }
    ...
    public Teacher update(Teacher teacher) throws TeacherDAOException {
        ...
        try(Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            throw new TeacherDAOException("SQL Error in Teacher.update " + teacher.toString());
        }
        return teacher;
    }
    ...
    public List<Teacher> getByLastname(String lastname) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            throw new TeacherDAOException("SQL ERROR in Teacher.getByLastName");
        }finally {
            try{
                if(rs!=null) rs.close();
    ...
    public Teacher getById(int id) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            throw new TeacherDAOException("SQL ERROR in Teacher.getById ");
        }finally {
            try{
                if(rs!=null) rs.close();
            }catch (SQLException e1){
